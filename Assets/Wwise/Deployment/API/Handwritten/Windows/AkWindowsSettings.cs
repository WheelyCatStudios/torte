#if (UNITY_STANDALONE_WIN || UNITY_EDITOR_WIN || UNITY_WSA) && !(UNITY_STANDALONE_OSX || UNITY_STANDALONE_LINUX || UNITY_EDITOR_OSX || UNITY_EDITOR_LINUX)
...
#if UNITY_STANDALONE_WIN || UNITY_EDITOR_WIN || UNITY_WSA || UNITY_WSA
